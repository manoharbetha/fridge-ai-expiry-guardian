...
export default function HeroSection() {
  return (
    <section className="relative w-full py-16 md:py-28 bg-gradient-to-br from-green-50 via-emerald-100 to-teal-50">
      <div className="max-w-5xl mx-auto flex flex-col items-center text-center px-4 gap-8">
        <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold mb-2 bg-gradient-to-b from-emerald-800 to-emerald-400 bg-clip-text text-transparent">
        ...
        <div className="max-w-2xl mx-auto mb-4 text-lg md:text-2xl text-emerald-900/80 font-medium">
          <TextRotate
            texts={[
              ...
              "The secret of health is in the fridge.",
              "Preserve freshness, minimize waste.",
              "Fresh today, healthy tomorrow.",
              "You are what you eat!",
            ]}
            mainClassName="bg-emerald-100 px-4 py-2 rounded-xl shadow-md min-h-[44px] font-bold text-emerald-700 text-lg md:text-2xl"
            staggerFrom="center"
