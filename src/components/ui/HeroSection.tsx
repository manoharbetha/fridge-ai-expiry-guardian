...
export default function HeroSection() {
  return <section className="relative w-full py-16 bg-gradient-to-br from-green-50 via-emerald-100 to-teal-50 md:py-[111px]">
      <div className="max-w-5xl mx-auto flex flex-col items-center text-center px-4 gap-8">
        <h1 className="text-4xl sm:text-6xl font-extrabold mb-2 bg-gradient-to-b from-emerald-800 to-emerald-400 bg-clip-text text-transparent px-0 mx-0 my-0 py-[14px] md:text-6xl">
