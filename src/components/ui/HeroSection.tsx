...
export default function HeroSection() {
  return <section className="relative w-full py-16 bg-gradient-to-br from-green-50 via-emerald-100 to-teal-50 md:py-[100px]">
      <div className="max-w-5xl mx-auto flex flex-col items-center text-center px-4 gap-8">
        <h1 className="text-4xl sm:text-6xl font-extrabold mb-2 bg-gradient-to-b from-emerald-800 to-emerald-400 bg-clip-text text-transparent px-0 mx-0 my-0 py-[8px] md:text-7xl">
        ...
        <div className="max-w-2xl mx-auto mb-4 text-lg md:text-2xl text-emerald-900/80 font-medium">
          ...
          ]} mainClassName="bg-emerald-100 px-4 py-2 rounded-xl shadow-md min-h-[44px] font-bold text-emerald-700 text-lg md:text-2xl" staggerFrom="center" initial={{
            y: "100%",
            opacity: 0
          }} animate={{
            y: 0,
