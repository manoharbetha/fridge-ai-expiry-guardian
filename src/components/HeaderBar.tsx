...
import { Refrigerator, Trash2, LogOut } from 'lucide-react';
    ...
    <div className="flex items-center justify-between mb-8 py-[11px]">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          {expiredItemsCount > 0 && 
            <Button onClick={onPurgeExpired} variant="destructive" className="shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-red-700 bg-red-700 text-white">
