...
const NaturalLanguageInput: React.FC<NaturalLanguageInputProps> = ({ onItemsParsed }) => {
  ...
  return (
    <Card className="p-4 bg-blue-50/50 border-blue-200">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h3 className="font-medium text-blue-800">Smart Input</h3>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <Input
          ...
          placeholder="Try: 'I just bought 2 apples, some milk, and chicken breast'"
          className="bg-white"
